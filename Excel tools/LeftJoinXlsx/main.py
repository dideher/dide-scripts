...
class GUI():
    def __init__(self):
        ...
        self.window.title("Σύνδεση αρχείων excel (Left join)")
    ...
    def saveFile(self):
        ...
        outputFile = os.path.join(self.outputDirName.get(), "output.xlsx")
    ...
    def run(self):
        ...
        self.data3.append(self.data1[0] + self.data2[0])
    ...
    def create_widgets(self):
        ...
        self.btnRun = Button(self.fData, text="Εκτέλεση σύνδεσης", command=self.run, state='disabled')
