...
class GUI():
    def __init__(self):
        ...
        self.window.title("Καθαρισμός αρχείου Βεβαιώσεων Αποδοχών")
    ...
    def createPdf(self):
        ...
        output = inFile.replace(".pdf", "_clean.pdf")
    ...
    def run(self):
        ...
        self.createPdf()
        showinfo(title="Ολοκλήρωση εκτέλεσης", message="Ο καθαρισμός του αρχείου ολοκληρώθηκε.")
