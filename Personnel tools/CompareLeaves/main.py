...
class GUI:
    def __init__(self):
        ...
        self.window.title("Σύγκριση αρχείων αδειών")
    ...
    def create_diff_report(self):
        not_found_in_1st = ''
        not_found_in_2nd = ''
        header = ['ΑΜ', 'ΑΦΜ', 'Φύλο', 'Επώνυμο', 'Όνομα', 'Πατρώνυμο', 'Κωδικός Κύριας Ειδικότητας',
                  'Κύρια Ειδικότητα', 'Κωδικός 2ης Ειδικότητας', '2η Ειδικότητα', 'Περιοχή Μετάθεσης Εκπαιδευτικού',
                  'Διεύθυνση Περιοχής Μετάθεσης Εκπ.', 'Περιφέρεια Περιοχής Μετάθεσης Εκπ.', 'Τρέχουσα Σχέση Εργασίας',
                  'Κατάσταση άδειας', 'Τύπος άδειας', 'Από', 'Αιτ. Ημέρες', 'Αρ. Πρωτ. Εισερχομένων',
                  'Ημ/νία Πρωτ. Εισερχομένων', 'Περιγραφή Αίτησης', 'Κωδικός Φορέα Δημιουργίας/Υποβολής',
                  'Φορέας Δημιουργίας/Υποβολής', 'Ημερομηνία Δημιουργίας', 'Ημερομηνία Υποβολής', 'Εγκρ. Ημέρες',
                  'Εγκρ. Μήνες', 'Εγκρ. Έτη', 'Αρ. Πρωτ. Εξερχομένων ', 'Ημ/νία Πρωτ. Εξερχομένων',
                  'Περιγραφή Απόφασης', 'Αιτιολόγηση Ανάκλησης', 'Κωδικός Φορέα Έγκρισης/Απόρριψης',
                  'Φορέας Έγκρισης/Απόρριψης', 'Ημερομηνία Τελευταίας Αλλαγής']

        print(20 * '-', 'Analysis', 20 * '-')
        for item1 in self.only_in1:
            last_name1 = item1[3]
            first_name1 = item1[4]
            father_name1 = item1[5]
            specialty1 = item1[6]
            type1 = item1[15]
            from_date1 = item1[16]
